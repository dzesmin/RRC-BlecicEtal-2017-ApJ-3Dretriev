...
wn, spectrum = rt.readspectrum("/home/jasmina/Work/3D-retrieval/opacity/opacityfile_TEAout_100.0_0.0_300_3000K_1-11um_flux.dat")
wl=1e4/wn

plt.ion()
plt.figure(1)
plt.clf()
plt.plot(wl, spectrum, "b", label="Planet spectrum")
plt.xlim(wl[-1], wl[0])
plt.legend(loc="best")

np.where(spectrum>1e5)
plt.savefig("Posle-editovanja.png")
