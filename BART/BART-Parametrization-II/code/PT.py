...
def PT_Inversion(p, params, verb=False):
     '''
     ...
     p2: Float
         Pressure in the middle of tLayer 2
     p3: Float
     ...
     # previous return good for plotting
...
def PT_generator(p, free_params, args):
  ...
  '''
  # pressure in PT_generator is passed in BARTfunc as from -- small to large
  ...
  if   args[0] == "line":
    ...
    # Jasmina commented above
    Temp = PT_Inversion(p, free_params)
  else:
