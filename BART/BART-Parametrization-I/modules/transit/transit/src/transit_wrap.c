...
/*-----------------------------------------------
              @(target):= _transit_module.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__transit_module

#else
#  define SWIG_init    init_transit_module

#endif
#define SWIG_name    "_transit_module"
...
SWIGINTERN PyObject *_wrap_set_radius(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  double arg1 ;
  double val1 ;
  int ecode1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:set_radius",&obj0)) SWIG_fail;
  ecode1 = SWIG_AsVal_double(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "set_radius" "', argument " "1"" of type '" "double""'");
  } 
  arg1 = (double)(val1);
  set_radius(arg1);
  resultobj = SWIG_Py_Void();
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"set_radius", _wrap_set_radius, METH_VARARGS, NULL},
