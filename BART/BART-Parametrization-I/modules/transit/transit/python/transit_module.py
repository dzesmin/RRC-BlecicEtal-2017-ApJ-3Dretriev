...
def transit_init(*args):
  return _transit_module.transit_init(*args)
...
def get_waveno_arr(*args):
  return _transit_module.get_waveno_arr(*args)
get_waveno_arr = _transit_module.get_waveno_arr

def set_radius(*args):
  return _transit_module.set_radius(*args)
set_radius = _transit_module.set_radius

def run_transit(*args):
  return _transit_module.run_transit(*args)
